...
\begin{itemize}
    \item tryb \texttt{--psm 8} (pojedyncze słowo),
...
\begin{itemize}
    ...
    \item czyszczony operacją morfologiczna 'open'
    \item automatycznie odwracany, jeśli tło jest ciemne,
    \item pogrubiany przy pomocy erozji
    \item przycinany i skalowany.
\end{itemize}
...
Po odczycie tekstu zastosowano (już wcześniej wspomniane) heurystyki poprawiające wynik:
\begin{itemize}
    \item zamiana cyfr na litery i odwrotnie (np. 0↔O, 1↔I),
    \item preferowanie tablic zaczynających się od liter,
    \item preferowanie długości 7-8 znaków,
